    ...
    return Scaffold(
      body: Stack(
        children: [
          /// Background image
          Positioned.fill(
            child: Image.asset("assets/images/Skin.png", fit: BoxFit.cover),
          ),
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Expanded(
              child: Text(
                "Skin manifestations are primarily driven by\n"
                "immune-mediated inflammation of small\n"
                "blood vessels, leading to cutaneous\n"
                "vasculitis and manifestations such as\n"
                "palpable purpura.¹",
                style: TextStyle(
                  color: purple,
                  fontSize: 22 * scale,
        ...
        Row(
          ...
          children: [
            ...
            Expanded(
              child: Text(
                "Cutaneous vasculitis is associated with\n"
                "more severe disease and an increased risk\n"
                "of lymphoma.³",
                style: TextStyle(
                  color: purple,
                  fontSize: 22 * scale,
    ...
    return Row(
      ...
      children: [
        Expanded(
          child: Text(
            "References:\n"
            "1. Kittridge A, Routhouska SB, Korman NJ. Dermatologic manifestations of Sjögren syndrome. Journal of cutaneous medicine and surgery. 2011;15(1):8-14.\n"
            "2. Soy M, Piskin S. Cutaneous findings in patients with primary Sjogren’s syndrome. Clinical Rheumatology. 2007;26(8):1350-2.\n"
            "3. André F, Böckle BC. Sjögren's syndrome. J Dtsch Dermatol Ges. 2022;20(7):980-1002.",
            style: TextStyle(
