...
class KidneysPage extends StatefulWidget {
  const KidneysPage({super.key});

  @override
  State<KidneysPage> createState() => _KidneysPageState();
}

class _KidneysPageState extends State<KidneysPage>
  ...
  Widget build(BuildContext context) {
    ...
    // Reference height: the height where your original sizes were designed
    // to fit comfortably. Tune this if needed (e.g. 800–900 for desktop).
    const referenceHeight = 800.0;
    final heightScale = (size.height / referenceHeight).clamp(0.55, 1.0);
    ...
    return Scaffold(
      body: Stack(
        children: [
          /// Background image
          Positioned.fill(
            child: Image.asset("assets/images/kidney.png", fit: BoxFit.cover),
          ),
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Expanded(
              child: Text(
                "Lymphocytic infiltration of renal\n"
                "tubules or immune complex deposition\n"
                "in Sjögren's disease can affect the\n"
                "kidneys. This may lead to\n"
                "tubulointerstitial nephritis or\n"
                "glomerulonephritis, the two most\n"
    ...
    return Row(
      ...
      children: [
        Expanded(
          child: Text(
            "Reference:\n"
            "1. Aiyegbusi O, McGregor L, McGeoch L, Kipgen D, Geddes CC, Stevens KI. Renal disease in primary Sjögren’s syndrome. Rheumatology and therapy. 2021;8(1):63-80.",
            style: TextStyle(
