...
class LymphNodesPage extends StatefulWidget {
  const LymphNodesPage({super.key});

  @override
  State<LymphNodesPage> createState() => _LymphNodesPageState();
}

class _LymphNodesPageState extends State<LymphNodesPage>
      ...
      children: [
              ...
              child: RichText(
                text: TextSpan(
                  ...
                  children: [
                    const TextSpan(
                      text:
                          "Persistent antigenic stimulation and B-cell\n"
                          "hyperactivation are key drivers of swollen\n"
                          "lymph nodes in Sjögren's disease, which are\n"
        ...
        Row(
          ...
          children: [
            ...
            Expanded(
              child: Text(
                "Patients with Sjögren's disease have a 14-fold\n"
    ...
    return Row(
      ...
      children: [
        Expanded(
          child: Text(
            "References:\n"
            "1. Stergiou IE, Chatzis LG, Pezoulas VC, et al. The clinical phenotype of primary Sjögren’s syndrome patients with lymphadenopathy. Clin Exp Rheumatol. 2022;40(12):2357-62.\n"
            "2. Liang Y, Yang Z, Qin B, Zhong R. Primary Sjögren's syndrome and malignancy risk: a systematic review and meta-analysis. Annals of the rheumatic diseases. 2014;73(6):1151-6.",
            style: TextStyle(
